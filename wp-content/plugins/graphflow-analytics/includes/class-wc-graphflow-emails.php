...
if ( ! class_exists( 'WC_Graphflow_Emails' ) ) {
	...
	class WC_Graphflow_Emails {
		...
		public function generate_email_rec_section(
			...
			$email_class = $rec_type == "email_order" ? "graphflow_recommendations_email" : "graphflow_recommendations_email_followup";
			...
			if ( $is_preview ) {
				...
				$gf_result = get_user_recommendations( $gf_userid, $gf_num, $filters, $rec_type );
